      ...
      <section className="py-20 bg-gradient-to-br from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white min-h-[80px] flex items-center justify-center">
              <TypewriterText 
                texts={["What We Offer"]}
                typingSpeed={100}
                deletingSpeed={60}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group p-8 rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-300 hover:scale-105"
                >
                  <div className="mb-6">
